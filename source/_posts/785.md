...
在 [497.md](/notes/497/) 中，我们曾探讨过嵌入向量在语义搜索中的局限性。传统的模型（如上月发布的 Llama-Nemotron-Embed-VL-1B）倾向于将整个文档编码为一个单一向量。这种方法虽然效率极高，但在处理细节极其丰富的视觉文档时，难免会丢失微小但关键的信息。
...
- 关联阅读：[445.md](/Mod/445/) 关于大规模语义索引的架构设计。
